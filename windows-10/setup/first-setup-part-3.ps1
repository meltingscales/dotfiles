...
choco install -y gimp libreoffice notepadplusplus inkscape audacity kdenlive obs-studio yed

# small little technical tools
choco install -y 7zip hxd sysinternals windirstat cpu-z hwinfo openhardwaremonitor prime95 furmark teamviewer bluescreenview 
#  intel-ipdt DNW
...
choco install -y virtualbox vagrant python3 ruby openjdk8 nodejs wireshark partitionwizard graphviz hugo
